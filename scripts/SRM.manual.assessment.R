...
plot_new <- ggplot(data_new, aes(x=row_n, y=A)) +
        ...
        geom_point(aes(y=outliers), size = 4, colour = "gray50") +
        geom_line(aes(y=outliers), size=1, colour = "gray50") +
        geom_point(aes(y=T3), size = 4, colour = "green") +
        geom_point(aes(y=T6), size = 4, colour = "orange") +
